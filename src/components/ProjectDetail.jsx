...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/rahmatvisual-19",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Rahmat Maulana Miftah</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Rahmat Maulana Miftah — Fullstack Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Rahmat Maulana Miftah`}
        />
        <meta
